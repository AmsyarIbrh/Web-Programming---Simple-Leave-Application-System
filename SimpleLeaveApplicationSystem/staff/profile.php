				...
				<div class="row flex-nowrap">
					...
					<div class="left-profile-page">
						...
						<div class="row">
							...
							<div class = "border border-black rounded p-1" style="background-color:#FFD3C4; margin-left:148px; width:400px; text-transform:uppercase;"><?php echo $row3['name']." "; ?> </div>
						</div>
						<br>
						<div class="row">
							<h4 class="profile"> Email </h4>
							<div class = "border border-black rounded p-1" style="background-color:#FFD3C4; margin-left:148px; width:400px;"> <?php echo $row3['email']." "; ?> </div>
						</div>
						<br>
						<div class="row">
							<h4 class="profile"> Password </h4>
							<div class = "border border-black rounded p-1" style="background-color:#FFD3C4; margin-left:120px; width:400px;"><?php echo $row3['password']." "; ?></div>
						</div>
						<br>
						<div class="row">
							<h4 class="profile"> Telephone Number </h4>
							<div class = "border border-black rounded p-1" style="background-color:#FFD3C4; margin-left:40px; width:400px;"> <?php echo $row3['telNo']." "; ?></div>
						</div>
						<br>
						<div class="row">
							<h4 class="profile"> Date of Birth </h4>
							<div class = "border border-black rounded p-1" style="background-color:#FFD3C4; margin-left:88px; width:400px;"><?php echo $row3['dateofBirth']." "; ?></div>
						</div>
						<br>
						<div class="row">
							<h4 class="profile"> Street </h4>
							<div class = "border border-black rounded p-1" style="background-color:#FFD3C4; margin-left:148px; width:400px; text-transform:uppercase;"> <?php echo $row3['street']." "; ?> </div>
						</div>
						<br>
						<div class="row">
							<h4 class="profile"> City </h4>
							<div class = "border border-black rounded p-1" style="background-color:#FFD3C4; margin-left:158px; width:400px; text-transform:uppercase;"> <?php echo $row3['dateofBirth']." "; ?> </div>
						</div>
						<br>
						<div class="row">
							<h4 class="profile"> Postcode </h4>
							<div class = "border border-black rounded p-1" style=" background-color:#FFD3C4; margin-left:118px; width:400px;"> <?php echo $row3['postcode']." "; ?> </div>
						</div>
						<br>
						<div class="row">
							<h4 class="profile"> State </h4>
							<div class = "border border-black rounded p-1" style=" background-color:#FFD3C4; margin-left:148px; width:400px; text-transform:uppercase;"> <?php echo $row3['state']." "; ?></div>
						</div>
						<br>		
					</div>
					...
					<div class="right-profile-page">
						...
						<div class="row">
							...
							<div class = "border border-black rounded p-1" style=" background-color:#FFD3C4; margin-left:92px; width:400px; text-transform:uppercase;"> 
								<?php echo $row4['dName']." "; ?>
							</div>
						</div>
						<br>
						<div class="row">
							...
							<div class = "border border-black rounded p-1" style="background-color:#FFD3C4; margin-left:120px; width:400px; text-transform:uppercase;"> 
								<?php echo $row3['role']." "; ?>
							</div>
						</div>
						<br>
